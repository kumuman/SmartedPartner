...
from AI_PPT.mdtree.parser import parse_string, Out, Heading
from AI_PPT.mdtree.utils import get_random_theme, get_random_file, read_md_file
import os
from AI_PPT.mdtree.img_search import get_img
import os
class Tree2PPT:
    ...
    def __init__(self, md_str1,theme_path,save_path=""):
        ...
        self.theme_param_path = self.theme+'/mode.json'
